...
public class Impresion extends ProcesamientoDef{
    ...
    public void procesa(Suma exp) {
        imprimeExpBin(exp.getOpnd0(), "+" + exp.getFilaColInfo(), exp.getOpnd1(), 2, 3);
    }
    public void procesa(Resta exp) {
        imprimeExpBin(exp.getOpnd0(), "-" + exp.getFilaColInfo(), exp.getOpnd1(), 3, 3);
    }
    ...
    public void procesa(Asignacion exp) {
        imprimeExpBin(exp.getOpnd0(), "=" + exp.getFilaColInfo(), exp.getOpnd1(), 1, 0);
    }
