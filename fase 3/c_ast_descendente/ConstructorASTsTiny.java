...
// ======== REGLAS SINTACTICAS ========
    ...
    try {
      ...
      case call:
        ...
        paramsR = paramsReales();
                 {if (true) return (Inst)sem.instr_call(id.image, paramsR).ponFila(id.beginLine).ponCol(id.beginColumn);}
        break;
      case 34:
        bloq1 = bloque();
                 {if (true) return sem.instr_bloque(bloq1);}
        break;
      default:
        jj_la1[12] = jj_gen;
        jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x50040000,0x0,0x50040000,0x40000000,0x0,0x40000000,0x0,0x0,0x41e000,0x0,0x2fa80000,0x0,0x2fa80000,0x100000,0x0,0x0,0x0,0x0,0xc0021c00,0x0,0x300,0x0,0xc0021c00,0x0,0xc0021800,0x0,0x0,0x400,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1400,0x20,0x1400,0x1600,0x100,0x1600,0x400,0x1000,0x0,0x100,0x2004,0x20,0x2004,0x0,0x40,0x100,0x4000,0x7e0000,0x8043,0x8000,0x0,0x3800000,0x8043,0x11400,0x43,0x7e0000,0x3800000,0x8000,};
   }
