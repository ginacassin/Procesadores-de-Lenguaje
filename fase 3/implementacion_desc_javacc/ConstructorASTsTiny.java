...
{if ("" != null) return (Dec)sem.dec_var(tipo, iden.image).ponFila(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }
      case type:{
        ...
        tipo = tipo0();
        iden = jj_consume_token(iden);
{if ("" != null) return (Dec)sem.dec_tipo(tipo, iden.image).ponFila(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }
      case proc:{
        ...
        bloq = bloque();
{if ("" != null) return (Dec)sem.dec_proc(iden.image, paramsF, bloq).ponFila(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }
      default:
        jj_la1[2] = jj_gen;
...
T tipo0; String iden;
      ...
      case 44:{
        ...
        jj_consume_token(41);
        iden = jj_consume_token(iden);
{if ("" != null) return sem.param_ref(tipo0, iden.image);}
        break;
        }
      case iden:{
        tipo0 = tipo0();
        iden = jj_consume_token(iden);
{if ("" != null) return sem.param(tipo0, iden.image);}
        break;
        }
      default:
        jj_la1[5] = jj_gen;
...
{if ("" != null) return sem.tipo_string();}
        iden = jj_consume_token(iden);
{if ("" != null) return (T)sem.tipo_iden(iden.image).ponFile(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }
      default:
        jj_la1[8] = jj_gen;
...
T tipo; String iden;
      tipo = tipo0();
      iden = jj_consume_token(iden);
{if ("" != null) return (Campo)sem.campo(tipo, iden.image).ponFile(iden.beginLine).ponCol(iden.beginColumn);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("campo");
    }
...
{if ("" != null) return e0;}
      ...
      case iden:{
        iden = jj_consume_token(iden);
{if ("" != null) return (Exp)sem.lit_ent(iden.image).ponFila(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }{
        iden = jj_consume_token(iden);
{if ("" != null) return (Exp)sem.lit_real(iden.image).ponFila(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }
      case TRUE:{
        jj_consume_token(TRUE);
{if ("" != null) return sem.lit_true();}
        break;
        }
      case FALSE:{
        jj_consume_token(FALSE);
{if ("" != null) return sem.lit_false();}
        break;
        }{
        iden = jj_consume_token(iden);
{if ("" != null) return (Exp)sem.lit_cadena(iden.image).ponFila(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }{
        iden = jj_consume_token(iden);
{if ("" != null) return (Exp)sem.identificador(iden.image).ponFila(iden.beginLine).ponCol(iden.beginColumn);}
        break;
        }
      case NULL:{
